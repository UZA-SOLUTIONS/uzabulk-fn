...
export const QUICK_LINKS = [
  ...
  { to: ROUTES.ABOUT_US, labelKey: "nav.aboutUs" },
  { to: ROUTES.CONTACT_US, labelKey: "nav.contactUs" },
  { to: ROUTES.PRIVACY_POLICY, labelKey: "nav.privacyPolicy" },
  { to: ROUTES.T_AND_C, labelKey: "nav.termsConditions" },
];
